<!-- Top Contact Bar -->
<div class="top-bar bg-dark text-white py-2 border-bottom border-secondary">
    <div class="container-fluid px-3 px-md-4 d-flex flex-column flex-md-row justify-content-between align-items-center">
        <div class="contact-details mb-2 mb-md-0 text-center text-md-start small">
            ...
            <span class="me-3"><i class="fa-solid fa-envelope me-1"></i> <a href="mailto:{{ config('school.email') }}" class="text-white text-decoration-none">{{ config('school.email') }}</a></span>
